...
- [ ] 판매자 정보(상호·대표자·사업자등록번호·주소·연락처) 기재 완료 — 게시 전 최신 값인지 최종 확인.
- [ ] **연락처**: 현재 이메일(ari.daily.creative@gmail.com)로 표기. 전자상거래법 제13조는 전화번호 표시도 요구하므로, 사업용 전화번호 추가 표기 검토.
- [ ] **통신판매업 신고** 여부 확인 — 국내 소비자 대상 유료 판매 시 신고가 원칙. 신고 후 신고번호를 본 안내에 추가. (면제 대상이면 그 근거 확인.)
